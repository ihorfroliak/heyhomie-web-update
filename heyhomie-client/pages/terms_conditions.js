...
import TCBodyPl from '../components/utilpages/terms_conditions/TCBodyPl';
import TCBodyEn from '../components/utilpages/terms_conditions/TCBodyEn';
...
function TermsConditionsPage({ cities }) {
    // UI translations for the component
    const t = useTranslations('UtilsPages.TermsConditionsPage');
    ...
    return (
        <>
            ...
            <ContentContainer>
                <ContentHeading>
                    {t(`heading`)}
                    <a download href='/REGULAMIN-STRONY.pdf'>
                        PDF
                    </a>
                </ContentHeading>
                <ContentBody>{router.locale === 'pl' ? <TCBodyPl /> : <TCBodyEn />}</ContentBody>
            </ContentContainer>
