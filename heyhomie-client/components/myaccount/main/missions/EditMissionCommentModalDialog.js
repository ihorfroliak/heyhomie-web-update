...
const EditMissionCommentModalDialogContainer = styled.div`
    position: 'relative';
...
const EditMissionCommentModalDialogContentContainer = styled.div`
    width: 100%;
    height: 100%;
...
const EditMissionCommentModalDialog = ({ service, handleValidateService, handleCancel }) => {
    // UI translations for the component
    const t = useTranslations('AccountPage.IndexPage.EditMissionCommentModalDialog');
    ...
    return (
        <EditMissionCommentModalDialogContainer isOpen={ui.editMissionCommentModalDialog}>
            {ui.editMissionCommentModalDialog && serviceInEdit ? (
                <EditMissionCommentModalDialogContentContainer>
                    <h2
                        style={{
                            marginBottom: `1rem`,
                        }}
                    ...
                    >
                        ...
                        <PrimaryButtonFull
                            ...
                            disabled={!service.config.user_comment}
                        >
                            {t(`validate_btn`)}
                        </PrimaryButtonFull>
                    </div>
        ...
        </EditMissionCommentModalDialogContainer>
    );
};

export default EditMissionCommentModalDialog;
