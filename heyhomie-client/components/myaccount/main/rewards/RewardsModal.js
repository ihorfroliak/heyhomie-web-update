            ...
            >
                <g clipPath='url(#clip0)'>
                    <path
                        ...
                        fill='#36F0C7'
                    />
                    <path d='M55.1591 12.0782L63.7776 0.012207H36.1982L44.8168 12.0782V15.5256H55.1591V12.0782Z' fill='#36F0C7' />
                    <path
                                    ...
                                    earnedItems.map(item => (
                                        <EarnedTabCard key={item.user.id}>
                                            ...
                                            <svg width='20' height='20' viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
                                                <rect x='1' y='1' width='18' height='18' rx='9' fill='#36F0C7' stroke='#36F0C7' strokeWidth='2' />
                                                <path
